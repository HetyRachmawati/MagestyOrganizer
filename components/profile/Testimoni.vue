...
.testimonial {
    background-color: #f1e6fd !important; /* Pastikan background warna diutamakan */
    background-image: none !important; /* Menonaktifkan background gambar jika ada */
}

.testimonial-item {
    background-color: #ac79f9 !important; /* Non transparan, solid color */
    border-radius: 10px;
